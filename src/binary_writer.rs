pub mod binary_writer {
    ...
    use crate::pmx_types::{
        ...
        PMXFace, PMXFrame, PMXIKLink, PMXJoint, PMXJointType, PMXMaterial, PMXMorph, PMXRigid,
        PMXRigidCalcMethod, PMXRigidForm, PMXSphereModeRaw, PMXToonModeRaw, PMXVertex,
        PMXVertexWeight, UVMorph, VertexMorph, BONE_FLAG_APPEND_ROTATE_MASK,
        BONE_FLAG_APPEND_TRANSLATE_MASK, BONE_FLAG_DEFORM_OUTER_PARENT_MASK,
        BONE_FLAG_FIXED_AXIS_MASK, BONE_FLAG_IK_MASK, BONE_FLAG_LOCAL_AXIS_MASK,
        BONE_FLAG_TARGET_SHOW_MODE_MASK,
    };
        ...
        pub(crate) fn write_pmx_morph(
            ...
            for morph_ in morph.morph_data {
                match morph_ {
                    ...
                    MorphTypes::Material(morph) => {
                        self.write_material_morph(s_material_index, morph)
                    }
